...
export default function Curiosidades() {
    return (
        <Container className="corpoPadrao">
            ...
            <Text>
                <span>Álcool – pode agir como estimulante, deixando a pessoa desinibida e eufórica, mas, conforme a quantidade ingerida aumenta, a depressão, a diminuição da coordenação motora, dos reflexos e o sono podem aparecer. As consequências do uso prolongado da droga é o alcoolismo, a cirrose, o câncer no fígado e danos ao cérebro.
            ...
            <Text>
                <span>Maconha – distorce os sentidos e a percepção do tempo e pode causar confusão mental, paranoia, pânico, agitação e alucinações. As possíveis consequências do uso de drogas, nesse caso, são a perda de memória e da habilidade de processar informações complexas, irritação no sistema respiratório e desenvolvimento do câncer de pulmão.</span>
            </Text>
            <Text>
                <span>Cocaína – pode causar a sensação de alerta e euforia ou de isolamento, ansiedade e pânico. As consequências do uso prolongado da droga são diminuição do sono, do cansaço e do apetite, alteração nos batimentos cardíacos, da pressão arterial e da temperatura. Quando usada em excesso, geralmente de forma injetável, pode causar overdose e morte.</span>
            </Text>
            <Text>
                <span>Crack – é uma droga proveniente da cocaína que causa agitação e euforia e, logo em seguida, depressão. As principais consequências do uso de drogas, nesse caso, são perda de apetite, desnutrição, insônia, rachaduras nos lábios e gengivas, tosse, problemas respiratórios e cardíacos e sensação de perseguição.
